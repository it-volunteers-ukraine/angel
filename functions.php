...
function wp_it_volunteers_scripts() {
  ...
  if (is_singular() && locate_template('template-parts/about-fund-section.php')) {
    wp_enqueue_style( 'about-fund-section', get_template_directory_uri() . '/assets/styles/template-parts-styles/about-fund-section.css', array('main') );
    wp_enqueue_script( 'about-fund-section', get_template_directory_uri() . '/assets/scripts/template-parts-scripts/about-fund-section.js', array(), false, true );
    }
